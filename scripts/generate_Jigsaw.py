...
@dataclass
class RunConfig:
    out_dir: Path = Path("./datasets/generated/Jigsaw_train")
    n_images: int = 50000
    vis_data: bool = False
    ...
    for _ in range(cfg.n_images):
        ...
        for _ in range(1000):
            try:
                ...
                prompt = (f"A puzzle picture showing a diverse {attributes_and_materials_txt} puzzle game scene, with {character_txt} brightly colored building blocks or pieces or product parts scattered around yet forming a whole.")
