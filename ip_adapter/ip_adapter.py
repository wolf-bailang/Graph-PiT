...
class IPAdapter:
    def __init__(self, sd_pipe, image_encoder_path, ip_ckpt, device, num_tokens=4):
        ...
        self.image_encoder = CLIPVisionModelWithProjection.from_pretrained(os.path.join(self.root_dir, "IP-Adapter"),
                                                                           subfolder=image_encoder_path).to(self.device, dtype=torch.float16)
